...
Επιπροσθέτως, η Mærsk δηλώνει και ελέγχεται από ανεξάρτητη αρχή για τις ετήσιες εκπομπές CO2. Για τη διευκόλυνση αυτού του ελέγχου, και τη διευθέτηση τυχόν ζητημάτων, απαιτείται όσο το δυνατόν μεγαλύτερη διαφάνεια και ελαχιστοποίηση ανθρώπνινων σφαλμάτων.
...
Η μεθοδολογία με την οποία υπολογίζονται οι εκπομπές CO2 είναι εκτός θέματος του δοκιμίου. Αξίζει να σημειωθεί ωστόσο, ότι υπολογίζονται με βάση διεθνώς αποδεκτή μεθοδολογία, για την οποία είναι υπεύθυνο διαφορετικό τμήμα της εταιρείας, ενώ υπόκειται σε έλεγχο από κρατικές αρχές (περισσότερα σχετικά, μετέπειτα). Ένα πολύ απλοποιημένο νοητικό μοντέλο για τις εκπομπές CO2, αποτελεί τη μέτρηση της καταναλισκόμενης ενέργειας για την ολοκλήρωση ενός ταξιδιού, και τη μετατροπή της ενέργειας αυτής σε CO2 (με έναν απλό πολλαπλασιασμό), με βάση έναν παράγοντα συγκεκριμένο για το είδος του καυσίμου. Για τη μέτρηση της απαιτούμενης ενέργειας μιας διαδρομής, πολύ απλά μπορεί να μετρηθεί η διαφορά στη μάζα του καυσίμου πριν και μετά τη διαδρομή, και να υπολογιστεί δεδομένου ότι είναι γνωστή η ενεργειακή απόδωση του καυσίμου ανά μονάδα μάζας.

Σαν ένα πιο απτό (και απλοποιημένο) παράδειγμα υπολογισμού: Για μια διαδρομή καταναλώνεται 1 kg πετρελαίου, με παράγοντα 3.5 gram CO2 / gram καυσίμου, άρα παράγονται 3.5 kg CO2. Αν αντίθετα είχε χρησιμοποιηθεί μεθανόλη με παράγοντα 0.5 gram CO2 / gram καυσίμου, θα είχαμε μόνο 0.5 kg CO2, δηλαδή 86% λιγότερες εκπομπές CO2.
